                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center max-w-7xl">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <div className="flex justify-center">
                            <button className="inline-flex text-white bg-red-600 border-0 py-2 px-6 focus:outline-none hover:bg-red-500 rounded text-lg">Order Now</button>
                            <button className="ml-4 inline-flex justify-center items-center text-black bg-transparent border-0 py-2 px-6 focus:outline-none hover:bg-green-600 hover:text-white rounded text-lg">
                                <BsFillPlayFill className='mr-5 text-yellow-300' />
                                Order Process
                            </button>
                        </div>
                    </div>
                    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        <Image className="object-cover object-center rounded" alt="hero" src='/image/Header Image.png' width={500} height={600} />
                    </div>
                </div>
            </section>
        </>
